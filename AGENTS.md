...
- Follow the implemented product boundaries, current architecture and development contracts. Workflow Packages remain the executable workflow authoring root; do not introduce compatibility shims or legacy execution paths unless explicitly re-scoped.
