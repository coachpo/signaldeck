...
const knownErrors: Record<string, ErrorNotice> = {
  ...
  binding_changed: { title: "本次设置已变化", description: "请重新核对服务、使用范围及用量与时间限制，再确认开始。输入已保留。" },
  budget_agent_unavailable: { title: "任务使用的助手已变化", description: "已保存的用量与时间限制包含当前任务不再使用的助手。请恢复工作流默认设置，再按当前助手重新调整。" },
