...
from finance_plugin import indicator_series
    ...
    def _compute_indicator_series(
        ...
        for indicator in indicators:
            ...
            if indicator.indicator == "sma" and indicator.window is not None:
                computed[key] = indicator_series.sma(closes, indicator.window)
            elif indicator.indicator == "ema" and indicator.window is not None:
                computed[key] = indicator_series.ema(closes, indicator.window)
            elif indicator.indicator == "rsi" and indicator.window is not None:
                computed[key] = indicator_series.rsi(closes, indicator.window)
            elif indicator.indicator == "macd":
                computed[key] = indicator_series.macd(
                    closes,
                ...
                computed[key] = indicator_series.bollinger(
                    closes,
                ...
                computed[key] = indicator_series.atr(rows, indicator.window)
            elif indicator.indicator == "vwma" and indicator.window is not None:
                computed[key] = indicator_series.vwma(rows, indicator.window)
        return computed
